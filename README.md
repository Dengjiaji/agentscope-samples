...
一个开源的金融交易智能体框架，通过多智能体协作和记忆系统，构建能够在真实市场中持续学习与进化的交易系统。
...
**多智能体协作交易**  
5种专业分析师角色（基本面、技术面、情绪、估值、综合）+ 投资组合经理 + 风险管理，像真实交易团队一样协作决策。
...
![交易大厅](./docs/images/dashboard.png)
...
- **记忆系统**：ReMe (Retrieval-enhanced Memory)
...
传统量化交易追求确定性与可重复性，但市场是动态演化的复杂系统。EvoTraders 不是一台完美校准的机器，而是一个活跃的生态系统：

- **观点碰撞**：分析师之间激烈的讨论和观点交锋
- **动态权衡**：投资经理对不同信息源的实时权衡
- **持续博弈**：风控与执行之间的平衡艺术
- **集体学习**：整个系统在市场反馈中不断进化

当 AI Agents 组成团队进入实时市场，它们会逐渐形成自己的交易风格和决策偏好，而不是一次性的随机推理。
