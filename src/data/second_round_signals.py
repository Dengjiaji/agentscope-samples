...
class TickerSignal(BaseModel):
    ...
    signal: Literal["bullish", "bearish", "neutral"] = Field(..., description="Investment signal")
...
class SecondRoundAnalysis(BaseModel):
    ...
    ticker_signals: List[TickerSignal] = Field(..., description="Investment signals for each stock")
