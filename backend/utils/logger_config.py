...
def enable_memory_debug():
    ...
    logging.getLogger("backend.memory.reme_memory").setLevel(logging.DEBUG)
    logging.getLogger("backend.memory.mem0_memory").setLevel(logging.DEBUG)
    logging.getLogger("backend.memory.manager").setLevel(logging.DEBUG)
