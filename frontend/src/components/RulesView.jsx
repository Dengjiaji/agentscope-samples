...
export default function RulesView() {
  ...
  const llmLogos = [
    { name: 'Alibaba', file: 'Alibaba.jpeg', label: 'Qwen' },
    { name: 'DeepSeek', file: 'DeepSeek.png', label: 'DeepSeek' },
    { name: 'Moonshot', file: 'Moonshot.jpeg', label: 'Moonshot' },
    { name: 'Zhipu AI', file: 'Zhipu AI.png', label: 'Zhipu AI' }
  ];
                ...
                {content.en.analysts.map(analyst => {
                  ...
                  return (
                    <div key={analyst.name} style={{
                      ...
                      {logo && (
                        <img
                          src={`/assets/llm_model_logos/${logo.file}`}
                          alt={logo.label}
                          style={{
                            height: '16px',
                            width: 'auto',
